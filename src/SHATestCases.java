...
public class SHATestCases {
	...
	public void setUp() throws Exception {
		...
		nurseCareTypes2.add(TypeOfRequest.NewbornCare);
		...
		Nurse nurse2 = sha.nursesRegisterting("nurse2", "nusrse2", "nurse2@email.com", "123", Gender.MALE,
				Location.Montreal, nurseCareTypes2, Language.English);
		nurse2.setSchedule(schedule2);
		...
		sha.RequestApp(patient3, Gender.MALE, TimeSlot.From_11_To_1, "", Language.English, TypeOfRequest.NewbornCare,
				"");
		sha.RequestApp(patient3, Gender.MALE, TimeSlot.From_1_To_3, "", Language.English, TypeOfRequest.VaccineCare,
				"");
