                                    ...
                                    switch (ans2) {
                                        case 1:
                                            ...
                                            do {
                                                ...
                                                if (timpeSlotChoice != 5) {
                                                    System.out.println("Pelease enter your time status for that slot:\n" + "0. Booked\n"
                                                            + "1. Avaiable\n" + "2. Not Working\n");
                                                    int workingchoice = sd.nextInt();
                                                    userN.getNurse().getSchedule()[timpeSlotChoice].setStatus(AvailableTimeStatusNures.values()[workingchoice]);
                                                }


                                            } while (timpeSlotChoice != 5);
                                            break;
